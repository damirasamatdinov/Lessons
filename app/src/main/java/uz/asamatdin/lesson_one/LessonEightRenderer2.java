 ...
 * used instead.
 */
public class LessonEightRenderer2 implements GLSurfaceView.Renderer {
	/** Used for debug logs. */
	 ...
	 */
	public LessonEightRenderer2(final LessonEightActivity lessonEightActivity) {
